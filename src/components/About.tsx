...
export default function About() {
  ...
  return (
    <section id="about" className="relative z-10 -mt-[60vh]">

      <div className="h-[30vh] w-full bg-gradient-to-b from-transparent to-white" />
      
      <div className="bg-white px-6 py-12 md:pb-24">
