...
export default function Location() {
  ...
  return (
    <section id="location" className="container mx-auto px-6 py-24">
      <div className="rounded-[3rem] bg-stone-900 p-8 text-stone-50 md:p-16">
        <div className="flex flex-col gap-12 lg:flex-row">
          ...
          <div className="relative h-96 overflow-hidden rounded-3xl bg-stone-800 lg:h-auto lg:w-1/2">
